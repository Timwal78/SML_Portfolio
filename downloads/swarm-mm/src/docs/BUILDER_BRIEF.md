...
- Live brokerage order **submission** (A remains signal + preview only; user submits)
- On-chain vault bytecode (B scaffold only)
- Rust execution hot path
- Full strict on-chain x402 verify (soft proof / operator key live; strict hooks ready)
