// Self-contained Black-Scholes option Delta. Computed locally from spot,
// strike, time-to-expiry, and implied volatility rather than trusted from a
// vendor's pre-computed greeks field — correct regardless of data-provider tier.
