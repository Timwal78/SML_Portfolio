...
export const CAPABILITIES: Capability[] = [
  ...
  {
    tool: 'squeezeos_council', product: 'SqueezeOS', paid: true, basePrice: '0.02',
  ...
  {
    tool: 'squeezeos_scan', product: 'SqueezeOS', paid: true, basePrice: '0.01',
  ...
  {
    tool: 'squeezeos_options', product: 'SqueezeOS', paid: true, basePrice: '0.01',
    paymentChains: ALL_CHAINS, freshnessSec: 60, attribution: false,
  ...
  {
    tool: 'squeezeos_iwm', product: 'SqueezeOS', paid: true, basePrice: '0.01',
  ...
  {
    tool: 'squeezeos_preview', product: 'SqueezeOS', paid: false, basePrice: '0.001',
  ...
  {
    tool: 'squeezeos_oracle', product: 'SqueezeOS', paid: false, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 5, attribution: false,
  ...
  {
    tool: 'leviathan_signal', product: 'SqueezeOS', paid: true, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 60, attribution: false,
  ...
  {
    tool: 'xmit_edgar_decode', product: 'SqueezeOS', paid: true, basePrice: '0.001',
  ...
  {
    tool: 'xdeo_earnings_estimate', product: 'SqueezeOS', paid: true, basePrice: '0.001',
  ...
  {
    tool: 'ftd_threshold_scan', product: 'SqueezeOS', paid: false, basePrice: '0.001',
  ...
  {
    tool: 'crawl_paid_fetch', product: 'SqueezeOS', paid: true, basePrice: '0.001',
  ...
  {
    tool: 'nexus_agent_hire', product: 'SqueezeOS', paid: false, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 0, attribution: false,
  ...
  {
    tool: 'proof_invoice', product: '402Proof', paid: false, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 0, attribution: false,
    tags: ['invoice', 'x402', 'payment', 'bill', 'quote', 'pay'],
    summary: 'Generate an x402 payment invoice for any SML endpoint.',
  },
  {
    tool: 'proof_verify', product: '402Proof', paid: false, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 0, attribution: false,
  ...
  {
    tool: 'proof_credit_score', product: '402Proof', paid: false, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 0, attribution: false,
  ...
  // ── XRPL Copy-Trader ──────────────────────────────────────────────────────
  {
    tool: 'copytrader_subscribe', product: 'Copy-Trader', paid: true, basePrice: '0.001',
  ...
  // ── Memecoin Launchpad ────────────────────────────────────────────────────
  {
    tool: 'launchpad_create', product: 'Launchpad', paid: true, basePrice: '0.001',
    paymentChains: ['xrpl'], freshnessSec: 0, attribution: false,
  ...
  {
    tool: 'shadow_query', product: 'Shadow Desk', paid: true, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 300, attribution: false,
  ...
  {
    tool: 'forge_llm', product: 'Forge Gateway', paid: true, basePrice: '0.001',
    paymentChains: ALL_CHAINS, freshnessSec: 0, attribution: false,
