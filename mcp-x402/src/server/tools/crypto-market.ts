...
// on x402 at $0.01/call -- highest-proven-demand category in the whole
// x402 ecosystem per Chainalysis' 2026 adoption report, and a real gap in
// this catalog: every other tool here is equities/federal data, nothing
// covers crypto market data despite this whole product being Base/XRPL-native.
