  ...
  products: [
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'pha_opportunities',      type: 'PAID', price_usdc: '0.001', description: 'SAM.gov opportunities filtered for housing authority / Section 8 / HCV work, with NAICS + set-aside filtering — real api.sam.gov data, nationwide' },
    ...
    },
    {
      ...
      tools: [
        { name: 'crypto_token_price', type: 'PAID', price_usdc: '0.001', description: 'Real-time price, market cap, and 24h volume/change for one or more tokens against one or more currencies' },
        { name: 'crypto_trending',    type: 'PAID', price_usdc: '0.001', description: 'Top 15 trending coins, 7 trending NFTs, and 6 trending categories by user search activity in the last 24h' },
      ],
    },
    {
      product: 'FX Rates',
      ...
      tools: [
        { name: 'fx_exchange_rate', type: 'PAID', price_usdc: '0.001', description: 'Latest or historical exchange rate for a base currency against one or more target currencies' },
      ],
    },
    {
      product: 'SqueezeOS',
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'ghost_route',  type: 'PAID', price_usdc: '0.001', description: 'Route transaction through dual-chain XRPL+Base gateway with toll collection' },
      ],
    },
    {
      product: '402Proof',
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'rails_transfer', type: 'PAID', price_usdc: '0.001', description: 'Initiate RLUSD or XRP transfer via SML Rails — returns tx_hash' },
      ],
    },
    {
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'agentcard_mint',   type: 'PAID', price_usdc: '0.001', description: 'Create new Ed25519 agent identity card — returns card JSON and DID' },
      ],
    },
    {
