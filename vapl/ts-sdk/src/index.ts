...
export {
  issueX402InteractionVC, createPresentation,
  vaplResponseHeaders, parseVaplHeaders,
} from './integration/x402';

export type { ProvenanceSoul, StoredSoul } from './types';
export type {
  VerifiableCredential, DataIntegrityProof, VerificationResult,
  InteractionClaim, AccuracyClaim, ContributionClaim,
  InteractionType, OutcomeType,
...
export type {
  X402InteractionContext, VerifiablePresentation,
} from './integration/x402';
