export const VAPL_CONTEXT = 'https://vapl.scriptmasterlabs.com/v1/context.jsonld';
export const VC_CONTEXT_V2 = 'https://www.w3.org/ns/credentials/v2';

export type InteractionType =
  | 'LeviathanSignalFetch' | 'CouncilVerdict' | 'SqueezeOSScan'
  | 'OptionsFlowFetch' | 'IWMScoreFetch' | 'MarketplaceRead'
  | 'MarketplaceListing' | 'FuturesPrediction' | 'SettlementResolution'
  | 'CrawltollFetch' | 'AgentHire' | 'RelayRoute' | 'WebhookSubscription'
...
export type CredentialSubject = {
  id: string;
} & ({ interaction: InteractionClaim } | { accuracy: AccuracyClaim } | { contribution: ContributionClaim });
